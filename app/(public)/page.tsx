  ...
  return (
    <div style={{ background: 'var(--bg)', color: 'var(--white)' }}>
      ...
      <section style={{ padding: '80px 0 0' }}>
        <div className="max-w-7xl mx-auto px-8 md:px-20 mb-10" data-animate>
          <span style={{ fontFamily: 'var(--font-body)', fontSize: '10px', fontWeight: 500, letterSpacing: '0.42em', textTransform: 'uppercase', color: 'var(--gold)', display: 'block', marginBottom: '12px' }}>
            {ru ? 'ВИРТУАЛЬНАЯ ЭКСКУРСИЯ' : 'WIRTUAL GEZELENÇ'}
          </span>
          <h2 style={{ fontFamily: 'var(--font-heading)', fontSize: 'clamp(28px, 4vw, 48px)', fontWeight: 300, color: 'var(--white)' }}>
            {ru ? 'Прогуляйтесь по HOŞ Lounge' : 'HOŞ Lounge gezelenç ediň'}
          </h2>
        </div>
        <VirtualTour />
      </section>
